...
def ptt_mic(
    language: str = "es-ES",
    hold_title: str = "Mantén presionado para hablar",
    unsupported_text: str = "🎙️ N/D",
    unsupported_title: str = "Tu navegador no soporta reconocimiento de voz (usa Chrome o Edge).",
    key: str | None = None,
) -> str | None:
    ...
    `hold_title`/`unsupported_text`/`unsupported_title` traducen los
    textos del botón según el selector de idioma de la interfaz (ver
    i18n.py) — el componente en sí no sabe de idiomas, solo muestra lo que
    se le pasa.
